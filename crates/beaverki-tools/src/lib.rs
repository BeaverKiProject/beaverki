...
impl Tool for ReadTextTool {
    ...
    async fn call(
        ...
        let resolved = resolve_allowed_path(path, context)?;
...
impl Tool for SearchFilesTool {
    ...
    async fn call(
        ...
        let resolved_root = resolve_allowed_path(root, context)?;
...
fn resolve_allowed_path(input: &str, context: &ToolContext) -> Result<PathBuf> {
